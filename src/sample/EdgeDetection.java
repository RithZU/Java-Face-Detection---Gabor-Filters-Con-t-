...
public class EdgeDetection {
    ...
    public static BufferedImage sobelOperation (BufferedImage image)
    {

        BufferedImage sobelResult = new BufferedImage(image.getWidth(),image.getHeight(),BufferedImage.TYPE_INT_RGB);
        ...
        for (int i = 1; i < x - 1; i++) {
            for (int j = 1; j < y - 1; j++) {
                ...
                sobelResult.setRGB(i, j, edgeColor);
            }
        }
